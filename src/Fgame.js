...
export default function Fgame() {
  return (
    ...
    <div className='bgq1'>
      ...
      <br/><br/>
      <p className="heading-txt">Game</p>
        <hr width="80%" size="5" color="black"/>
      <br/>
      <Link to="/G1" className="op"><button className="op1">Puzzle</button><br/></Link>
     
      <Link to="/G2" className="op"><button className="op1">Pexexo</button><br/></Link>
   
      <Link to="/G3" className="op"><button className="op1">Tic-Tac-Toe</button><br/></Link>
   
      <Link to="/G6" className="op"><button className="op2">Letter Hunt</button><br/></Link>
  <br/><br/><br/><br/>
      <br/>
      </div>
