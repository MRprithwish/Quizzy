...
export default function Qgame() {
  return (
    ...
    <div className='bgq'>
      ...
      <br/>
      <br/>
      <div className='signup1'><br/>
      <p className="heading-txt">Quizz</p>
        <hr width="80%" size="5" color="black"/>
      <br/>
      <br/>
      <Link to="/Q1" className="op"><button className="op1">Computer</button><br/></Link>
     
      <Link to="/Q2" className="op"><button className="op1">Science</button><br/></Link>
   
      <Link to="/Q3" className="op"><button className="op1">Sports</button><br/></Link>
   
      <Link to="/Q4" className="op"><button className="op2">Movie</button><br/></Link>
  <br/><br/><br/><br/>
      <Link to="/Q5" className="op"><button className="op3">History</button><br/></Link>
     <br/><br/><br/><br/>
      <Link to="/Q6" className="op"><button className="op4">Geography</button><br/></Link>
