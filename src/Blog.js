...
export default function Blog() {
  return (
    ...
    <div><a href="">
    <ul className='ulz'>
      <li className="liz"><Link to="/" className="link">Home</Link></li>
      <li className="liz"><Link to="/Blog" className="link">Blog</Link></li>
      <li className="liz"><Link to="/Create" className="link">Create</Link></li>
      <li className="liz">
            <li className="lizz" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Category</li>
